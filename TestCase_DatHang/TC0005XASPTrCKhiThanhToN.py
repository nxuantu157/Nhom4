...
class TC0005XASPTrCKhiThanhToN(unittest.TestCase):
    def setUp(self):
    ...
    def test_t_c0005_x_a_s_p_tr_c_khi_thanh_to_n(self):
        driver = self.driver
        ...
        driver.find_element_by_id("ContentPlaceHolder1_DataList1_Image1_7").click()
        driver.get("http://hauiproj.somee.com/ChiTietSanPham.aspx?ID=67")
        ...
        driver.find_element_by_id("ContentPlaceHolder1_Datalist1_txtSoLuong_0").send_keys("10")
