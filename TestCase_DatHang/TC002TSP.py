...
class TC002TSP(unittest.TestCase):
    def setUp(self):
    ...
    def test_t_c002_t_s_p(self):
        driver = self.driver
        driver.get("http://hauiproj.somee.com/Default.aspx")
        driver.find_element_by_id("LinkDN").click()
        ...
        driver.find_element_by_id("ContentPlaceHolder1_txtTaikhoan").send_keys("XYZ123")
        ...
        driver.find_element_by_id("ContentPlaceHolder1_txtMatkhau").send_keys("XYZ123")
        driver.find_element_by_id("ContentPlaceHolder1_btDangnhap").click()
        driver.get("http://hauiproj.somee.com/Default.aspx")
        driver.find_element_by_xpath("//a[@id='HyperLink2']/li").click()
        driver.get("http://hauiproj.somee.com/Kinhmat.aspx")
        driver.find_element_by_id("ContentPlaceHolder1_DataList1_Image1_6").click()
        driver.get("http://hauiproj.somee.com/ChiTietSanPham.aspx?ID=66")
        ...
        driver.find_element_by_xpath("//table[@id='ContentPlaceHolder1_dtlThongTinUser']/tbody/tr/td/table/tbody/tr[4]").click()
        ...
        driver.find_element_by_id("ContentPlaceHolder1_dtlThongTinUser_txtEmail_0").send_keys("tuantit190905@gmail.com")
        ...
        driver.find_element_by_id("ContentPlaceHolder1_dtlThongTinUser_txtGhiChu_0").send_keys("SHip nhanh giup em")
