...
class TC003TSPKhiCNHNg(unittest.TestCase):
    def setUp(self):
    ...
    def test_t_c003_t_s_p_khi_c_n_h_ng(self):
        driver = self.driver
        ...
        driver.find_element_by_id("ContentPlaceHolder1_DataList1_Image1_3").click()
        driver.get("http://hauiproj.somee.com/ChiTietSanPham.aspx?ID=63")
        ...
        driver.find_element_by_id("ContentPlaceHolder1_Datalist1_txtSoLuong_0").send_keys("15")
        ...
        driver.find_element_by_id("ContentPlaceHolder1_dtlThongTinUser_txtGhiChu_0").send_keys("ship hoa toc!")
