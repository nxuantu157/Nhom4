...
class TC002NgNhPSaiThNgTin(unittest.TestCase):
    def setUp(self):
    ...
    def test_t_c002_ng_nh_p_sai_th_ng_tin(self):
        driver = self.driver
        ...
        driver.find_element_by_id("ContentPlaceHolder1_txtMatkhau").send_keys("abc123!@#")
