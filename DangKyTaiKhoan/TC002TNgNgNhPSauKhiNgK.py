...
class TC002TNgNgNhPSauKhiNgK(unittest.TestCase):
    def setUp(self):
    ...
    def test_t_c002_t_ng_ng_nh_p_sau_khi_ng_k(self):
        driver = self.driver
        ...
        driver.find_element_by_id("ContentPlaceHolder1_txtTaiKhoan").send_keys("thinh1231w")
        driver.find_element_by_id("ContentPlaceHolder1_txtMatKhau").clear()
        driver.find_element_by_id("ContentPlaceHolder1_txtMatKhau").send_keys("iawh")
