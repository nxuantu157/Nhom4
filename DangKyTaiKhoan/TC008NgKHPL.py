...
class TC008NgKHPL(unittest.TestCase):
    def setUp(self):
    ...
    def test_t_c008_ng_k_h_p_l(self):
        driver = self.driver
        ...
        driver.find_element_by_id("ContentPlaceHolder1_txtTaiKhoan").send_keys("abcjaweoiu")
        driver.find_element_by_id("ContentPlaceHolder1_txtMatKhau").clear()
        driver.find_element_by_id("ContentPlaceHolder1_txtMatKhau").send_keys(u"hăhiewajh")
        driver.find_element_by_id("ContentPlaceHolder1_txtHoTen").clear()
        driver.find_element_by_id("ContentPlaceHolder1_txtHoTen").send_keys("jahtwin")
        ...
        driver.find_element_by_id("ContentPlaceHolder1_txtNamSinh").send_keys("2025-12-05")
        ...
        driver.find_element_by_id("ContentPlaceHolder1_txtEmail").click()
        driver.find_element_by_id("ContentPlaceHolder1_txtEmail").clear()
        driver.find_element_by_id("ContentPlaceHolder1_txtEmail").send_keys("tungthinh23@gmail.")
        driver.find_element_by_id("ContentPlaceHolder1_txtDiaChi").click()
